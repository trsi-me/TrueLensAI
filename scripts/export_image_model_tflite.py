# -*- coding: utf-8 -*-
# Export image_model.h5 → image_model.tflite (e.g. low-RAM deploy). Needs: pip install -r requirements.txt
# DepthwiseConv2D/groups issues: pip uninstall keras keras-nightly -y then tensorflow from requirements.txt.
...
def _patch_depthwise_conv2d_drop_groups() -> None:
    # Strip groups=1 from DepthwiseConv2D config (some Keras 3 builds reject it on load).
